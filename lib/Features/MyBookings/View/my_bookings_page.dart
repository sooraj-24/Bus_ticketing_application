...
class MyBookingsPage extends StatefulWidget {
  const MyBookingsPage({Key? key, required this.token}) : super(key: key);
  final String token;
  @override
  State<MyBookingsPage> createState() => _MyBookingsPageState(token: token);
}

class _MyBookingsPageState extends State<MyBookingsPage> {
  _MyBookingsPageState({required this.token});
  final String token;
  @override
  void initState() {
                        ...
                        child: controller.state == ViewState.Idle
                          ...
                          itemBuilder: (context, index){
                            return TicketCard(
                              ...
                              busId: controller.bookings.tickets![index].busId!,
